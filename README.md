...
- [Switch case: Multiple cases call the same function](java/switch-cases-call-the-same-function)
...
- [Remove files from git staging area](git/remove-files-from-staging-area)
